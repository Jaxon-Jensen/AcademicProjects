...
def search():
    #[[songName, artist, artist, uri], ...]
    return 1

def main():
    print("Spotify is working")
    #print(sp.search("simple days", limit=5)['tracks']['items'][0]['uri'])
    sp.start_playback(device_id=did, uris=["spotify:track:76d3DYrQGyPy0QYodY4R6T"])
